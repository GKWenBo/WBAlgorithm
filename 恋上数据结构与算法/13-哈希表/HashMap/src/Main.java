...
//    static void test1() {
//        String filepath = "/System/Library/Accounts";
...
//    }
    ...
    static void test5(HashMap<Object, Integer> map) {
        ...
        static void test6(TreeMap<Integer, Integer> map) {
        map.put(1, 1);
        map.put(2, 2);
        System.out.println(map.size());
        Asserts.test(map.size() == 2);
        Asserts.test(map.get(2) == 2);

        map.put(1, 10);
        Asserts.test(map.get(1) == 10);

        map.remove(2);
        Asserts.test(map.size() == 1);

        Asserts.test(map.containsKey(1));
    }

    static  void test7(LinkedHashMap<Integer, Integer> map) {
        map.put(1, 1);
        map.put(2, 2);
        map.put(6, 6);
        map.put(10, 100);
